...
namespace ClinicaDentariaFinalWork.Controllers
{
    public class InvoicesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ID,InvoiceNumber,Procedure,Value,Status")] Invoice invoice)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,InvoiceNumber,Procedure,Value,Status")] Invoice invoice)
        {
            if (id != invoice.ID)
            {
                return NotFound();
