...
namespace ClinicaDentariaFinalWork.Controllers
{
    public class ClientsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ID,Name,Birthday,Address,Locality,ZipCode,TaxPayerNumber,HealthInsurance")] Client client)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,Name,Birthday,Address,Locality,ZipCode,TaxPayerNumber,HealthInsurance")] Client client)
        {
            if (id != client.ID)
            {
                return NotFound();
